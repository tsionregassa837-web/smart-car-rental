...
from .models import Car, Booking, Contact, RentalInspection, ExtraCharge
...
class RentalInspectionAdmin(admin.ModelAdmin):
    list_display = ("booking", "inspection_type", "mileage", "fuel_level", "damage_found", "created_by", "created_at")
    list_filter = ("inspection_type", "damage_found", "fuel_level")
    search_fields = ("booking__first_name", "booking__last_name", "booking__email", "booking__id")
    readonly_fields = ("created_at",)


@admin.register(ExtraCharge)
class ExtraChargeAdmin(admin.ModelAdmin):
    list_display = ("booking", "charge_type", "amount", "created_by", "created_at")
    list_filter = ("charge_type",)
    search_fields = ("booking__first_name", "booking__last_name", "description")
    readonly_fields = ("created_at",)
